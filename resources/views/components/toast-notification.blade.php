<div x-data="{
    ...
    remove(id) {
     ...
     x-on:toast.window="add($event.detail.message)"
     class="fixed bottom-4 right-4 z-50 space-y-2 max-w-sm w-full px-4 pointer-events-none">
    <template x-for="toast in toasts" :key="toast.id">
        <div x-show="true"
             ...
             class="pointer-events-auto w-full bg-white shadow-lg rounded-lg border border-gray-200 overflow-hidden">
            <div class="p-4">
