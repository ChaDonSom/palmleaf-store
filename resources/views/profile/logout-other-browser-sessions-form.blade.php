<jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Log Out Other Browser Sessions') }}
            </jet-button>

            <jet-action-message class="ml-3" on="loggedOut">
                {{ __('Done.') }}
            </jet-action-message>
        </div>

        <!-- Log Out Other Devices Confirmation Modal -->
        <jet-dialog-modal wire:model="confirmingLogout">
            <x-slot name="title">
                {{ __('Log Out Other Browser Sessions') }}
            </x-slot>
            ...
            <x-slot name="footer">
                <jet-secondary-button wire:click="$toggle('confirmingLogout')" wire:loading.attr="disabled">
                    {{ __('Cancel') }}
